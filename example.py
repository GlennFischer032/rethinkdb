...
# disctance between the United States(id=11017e65-3fc7-44a7-b0f1-2062a662c30e)
# and the Czech Republic(id=0d4cbf7e-933c-43dc-9626-6571c5d99ce4) =~ 8228 km
print(db.table('country_locations').get('11017e65-3fc7-44a7-b0f1-2062a662c30e')['location']
      .distance(db.table('neviem').get('0d4cbf7e-933c-43dc-9626-6571c5d99ce4')['location'], unit='km').run())
